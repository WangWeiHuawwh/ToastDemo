...
public class AppMsg {
    ...
    public static AppMsg makeText(Activity context, CharSequence text) {
        return makeText(context, text, new AppMsg.Style(AppMsg.LENGTH_SHORT, R.color.black), R.layout.app_msg);
    }
    ...
    private static AppMsg makeText(Activity context, CharSequence text, Style style, View view, boolean floating, float textSize) {
        ...
        ImageView close_icon = (ImageView) view.findViewById(R.id.close_icon);
