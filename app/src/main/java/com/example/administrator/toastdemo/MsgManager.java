...
import static com.example.administrator.toastdemo.AppMsg.LENGTH_STICKY;
...
class MsgManager extends Handler implements Comparator<AppMsg> {
    ...
    private static class OutAnimationListener
    ...
    static class ReleaseCallbacksIcs
            implements ActivityLifecycleCallbacks, ReleaseCallbacks {
